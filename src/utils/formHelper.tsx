...
export const getErrorByFieldPath = <T extends FieldValues>(
    pathToField: Path<T>,
    error: FieldErrors<T>
): FieldError => {
...
const createFormElement = <TC,>(Component: ElementType) => {
    return function <T extends FieldValues>({
        validateOptions,
        name,
        labelText,
        children,
...
export const TextareaFL =
    createFormElement<JSX.IntrinsicElements['textarea']>('textarea');
export const InputFL =
    createFormElement<JSX.IntrinsicElements['input']>('input');
export const SelectFL =
    createFormElement<JSX.IntrinsicElements['select']>('select');
